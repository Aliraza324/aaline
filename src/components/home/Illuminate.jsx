      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className={`relative h-[350px] md:h-[350px] group cursor-pointer mb-12 stagger-item ${gridVisible ? 'visible' : ''}`}
            >
              ...
              <div className="absolute -bottom-8 left-6 right-6 bg-white rounded-2xl p-5 shadow-lg transition-all duration-500 group-hover:shadow-2xl group-hover:-bottom-10 group-hover:scale-105">
                <h3
